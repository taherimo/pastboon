calc_pairwise_reach <- function(net, method = c("BNp", "SDDS", "PEW"), params,
  ...
  switch(match.arg(method),
         BNp = {
           ...
           if (asynchronous) {
             pairwise_reachability <- .Call("calc_pairwise_reachability_BNp_async_R", inputs, input_positions,
             ...
             pairwise_reachability <- .Call("calc_pairwise_reachability_BNp_sync_R", inputs, input_positions,
                                           outputs, output_positions,
                                           as.integer(net$fixed),
                                           params,
         ...
         SDDS = {
           ...
           if (asynchronous) {
             pairwise_reachability <- .Call("calc_pairwise_reachability_SDDS_async_R", inputs, input_positions,
                                           outputs, output_positions,
                                           as.integer(net$fixed),
             ...
             pairwise_reachability <- .Call("calc_pairwise_reachability_SDDS_sync_R", inputs, input_positions,
                                           outputs, output_positions,
                                           as.integer(net$fixed),
                                           params$p00, params$p01, params$p10, params$p11,
                                           states_dec, num_states,
         ...
         PEW = {
           ...
           if (asynchronous) {
             pairwise_reachability <- .Call("calc_pairwise_reachability_PEW_async_R", inputs, input_positions,
                                           outputs, output_positions,
                                           as.integer(net$fixed),
             ...
             pairwise_reachability <- .Call("calc_pairwise_reachability_PEW_sync_R", inputs, input_positions,
                                           outputs, output_positions,
                                           as.integer(net$fixed),
  ...
  pairwise_reachability <- matrix(pairwise_reachability, nrow = num_states, byrow = TRUE)
  # colnames(transition_matrix) <- net$genes

  return(pairwise_reachability)
}
