  ...
  // the gene is not fixed
  {
    ...
    for (k = net->input_positions[geneIdx];
      ...
      // if the input of the function is not 0 (constant gene), take input bit
      {
        ...
        // GET_BIT(currentState[geneIdx / BITS_PER_BLOCK_32], geneIdx %
        // BITS_PER_BLOCK_32);
...
static inline void
state_transition_SDDS_asynchronous(unsigned int *currentState,
                                   double *update_prob,
                                   StochasticDiscreteDynamicalSystem *net) {
  unsigned int i;
...
void state_transition_SDDS_synchronous(unsigned int *currentState,
                                       StochasticDiscreteDynamicalSystem *net,
  ...
  for (i = 1; i <= net->num_nodes; ++i) {
    ...
    // the gene is not fixed
    {
      ...
      //(GET_BIT(currentState[(i-1) / BITS_PER_BLOCK_32], (i-1) %
      //BITS_PER_BLOCK_32) << (idx % BITS_PER_BLOCK_32));
...
double *get_node_activities_SDDS_async_last_step(
    StochasticDiscreteDynamicalSystem *net, double *update_prob,
...
double *get_node_activities_SDDS_sync_last_step(
    StochasticDiscreteDynamicalSystem *net, double *initial_prob,
    unsigned int num_repeats, int num_steps, unsigned int num_elements) {
...
double **count_pairwise_transitions_SDDS_async(
    StochasticDiscreteDynamicalSystem *net, double *update_prob,
    unsigned int **states, unsigned int num_states, unsigned int num_repeats,
...
double **count_pairwise_transitions_SDDS_sync(
    StochasticDiscreteDynamicalSystem *net, unsigned int **states,
...
double **calc_pairwise_reachability_SDDS_async(
    StochasticDiscreteDynamicalSystem *net, double *update_prob,
    unsigned int **states, unsigned int num_states, unsigned int num_repeats,
    int num_steps, unsigned int num_elements) {
...
double **calc_pairwise_reachability_SDDS_sync(
    StochasticDiscreteDynamicalSystem *net, unsigned int **states,
    unsigned int num_states, unsigned int num_repeats, int num_steps,
    unsigned int num_elements) {
...
unsigned int **get_reached_states_SDDS_async_batch(
    StochasticDiscreteDynamicalSystem *net, double *update_prob,
...
unsigned int **get_reached_states_SDDS_sync_batch(
    StochasticDiscreteDynamicalSystem *net, unsigned int *initial_states,
...
unsigned int **get_reached_states_SDDS_async_single(
    StochasticDiscreteDynamicalSystem *net, double *update_prob,
...
unsigned int **get_reached_states_SDDS_sync_single(
    StochasticDiscreteDynamicalSystem *net, unsigned int *initial_state,
    unsigned int num_repeats, int num_steps, unsigned int num_elements)
...
SEXP count_pairwise_transitions_SDDS_async_R(SEXP inputs, SEXP input_positions,
                                           SEXP outputs, SEXP output_positions,
                                           SEXP fixed_nodes, SEXP p00, SEXP p01,
  ...
  double **transition_matrix = count_pairwise_transitions_SDDS_async(
...
SEXP count_pairwise_transitions_SDDS_sync_R(SEXP inputs, SEXP input_positions,
                                          SEXP outputs, SEXP output_positions,
                                          SEXP fixed_nodes, SEXP p00, SEXP p01,
  ...
  double **transition_matrix = count_pairwise_transitions_SDDS_sync(
...
SEXP calc_pairwise_reachability_SDDS_async_R(SEXP inputs, SEXP input_positions,
                                             SEXP outputs, SEXP output_positions,
                                             SEXP fixed_nodes, SEXP p00, SEXP p01,
                                             SEXP p10, SEXP p11, SEXP update_prob,
                                             SEXP states, SEXP num_states,
  ...
  double **reachability_matrix = calc_pairwise_reachability_SDDS_async(
    &network, _update_prob, _states_2d, _num_states, _num_repeats, _num_steps,
    _num_elements);
...
SEXP calc_pairwise_reachability_SDDS_sync_R(SEXP inputs, SEXP input_positions,
                                            SEXP outputs, SEXP output_positions,
                                            SEXP fixed_nodes, SEXP p00, SEXP p01,
                                            SEXP p10, SEXP p11, SEXP states,
                                            SEXP num_states, SEXP steps,
  ...
  double **reachability_matrix = calc_pairwise_reachability_SDDS_sync(
    &network, _states_2d, _num_states, _num_repeats, _num_steps,
    _num_elements);
...
SEXP get_reached_states_SDDS_async_single_R(
    SEXP inputs, SEXP input_positions, SEXP outputs, SEXP output_positions,
    SEXP fixed_nodes, SEXP p00, SEXP p01, SEXP p10, SEXP p11, SEXP update_prob,
